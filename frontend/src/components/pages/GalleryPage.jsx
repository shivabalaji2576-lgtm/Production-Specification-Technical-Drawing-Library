      ...
      <div className="gallery-grid">
        <div className="gallery-card glass-panel">
          <div className="gallery-image-box">
            <img src="/factory_floor.png" alt="Cap Production Line" />
          </div>
        ...
        <div className="gallery-card glass-panel">
          <div className="gallery-image-box">
            <img src="/product_showcase.png" alt="SV Closures Product Portfolio" />
          </div>
          <div className="gallery-card-body">
        ...
        <div className="gallery-card glass-panel">
          <div className="gallery-image-box">
            <img src="/quality_lab.png" alt="Quality Inspection Center" />
          </div>
          <div className="gallery-card-body">
